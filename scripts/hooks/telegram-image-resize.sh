...
# Védelem: ha egy >500KB Telegram-fogadott kép kerülne a Nexus session-be, a
...
#
# Hatás: minden Nexus-szerű ágens automatikusan védve van az óriás-image-
...
# Stderr log a Nexus-pane-be (debug)
